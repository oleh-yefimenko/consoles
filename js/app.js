(() => {
    ...
    function initSliders() {
        if (document.querySelector(".main-slider__slider")) new core(".main-slider__slider", {
            ...
            navigation: {
                prevEl: ".main-slider__arrow_prev._icon-arrow-prev",
                nextEl: ".main-slider__arrow_next._icon-arrow-next"
            },
            on: {}
        });
        if (document.querySelector(".games-slider__slider")) new core(".games-slider__slider", {
            ...
            loop: true,
            navigation: {
                prevEl: ".games-slider__arrow_prev._icon-arrow-prev",
                nextEl: ".games-slider__arrow_next._icon-arrow-next"
            },
            breakpoints: {
                320: {
                    slidesPerView: 1.1,
    ...
    if (searchButton) searchWrapper.addEventListener("click", (function(e) {
        htmlSearch.classList.toggle("_active-search");
        searchButton.classList.toggle("_active-search");
        headerSearch.classList.toggle("_active-search");
    }));
    const videoPlayer = document.querySelector(".description__video-block");
    const btnPlay = document.querySelector("._icon-play");
    const btnPause = document.querySelector("._icon-pause");
    const video = document.querySelector(".description__video");
    if (videoPlayer) {
        btnPlay.addEventListener("click", (function() {
            video.play();
            videoPlayer.classList.add("_video-active");
        }));
        btnPause.addEventListener("click", (function() {
            video.pause();
            videoPlayer.classList.remove("_video-active");
        }));
    }
    window["FLS"] = true;
    isWebp();
